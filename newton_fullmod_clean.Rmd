...
coeff_change_plot <- function(result_df, glm_fit){
  ...
  coeff_change_plot <-
    ...
    labs(y = "Coefficient Values",
         title = "Newton Rapshon Coefficeint Values Change over Iteraions")
...
coeff_convergence_plot <- function(result_df, glm_fit){
  ...
  coeff_convergence_plot <-
    ...
    geom_line() +
    geom_point(aes(x = 14.06, y = 0), col = "lightblue") +
    theme(legend.position = "bottom", plot.title = element_text(hjust = 0.5, face = "bold")) +
    labs(y = "Coefficient Values",
         title = "Newton Rapshon Coefficeint Convergence over Iterations") 
