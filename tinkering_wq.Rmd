...
$$
\min_{(\beta_0, \beta_1, \dots, \beta_{30})}L(\beta_0, \beta_1, \dots, \beta_30) = \left\{-l(\beta_0, \beta_1, \dots, \beta_{30}) + \lambda \sum_{j=0}^{30}|\beta_j|\right\}
\\
\lambda_{max} = \sum_{j=1}^{30} |\beta_j|
$$
