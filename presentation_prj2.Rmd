...
According to NIH, there have been an estimated: 
...
Toward this end, we want to develop and evaluate the performance of two predictive models.
...
- The available predictors include measurements such as radius, texture, perimeter, area, smoothness, compactness, concavity, concave points, symmetry, and fractal dimension.

## Correlation Heat Plot of all Covariates

```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width = 12, fig.asp=0.8, fig.align='center'}
bc_corr <- bc %>% 
...
## Coefficients Comparison: Model Performance
...
Duncan, J. R. (2017, September 1). Information overload: When less is more in medical imaging. De Gruyter. Retrieved March 27, 2022, from https://www.degruyter.com/document/doi/10.1515/dx-2017-0008/html?lang=en 
