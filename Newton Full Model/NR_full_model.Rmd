...
```{r, echo = FALSE}
cat("True Beta0:",-3.2,",","Beta1:", -11.096,",", "Beta2:",0.270,",","Beta3:", 1.359,",","Beta4:", 0.037)
```
...
cat(c("\\begin{table}[!htb]
    ...
    \\begin{minipage}{.5\\linewidth}
      \\centering
        \\caption{True coefficients of 31 parameters}",
        t2,
    "\\end{minipage} 
\\end{table}"
))  
...
It is to be observed most of the $\beta_i$ increase as Newton Raphson algorithm proceeds. This causes some of the elements in p vector to be very close to 1, leading the next log likelihood to diverge to negative infinity. As a result, Newton Raphson algorithm cannot go further. 
